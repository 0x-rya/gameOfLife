...
# 
        ...
        if x == 0 and y == 0:
            ...
            return [automata[y + 1][x], automata[y][x + 1], automata[y + 1][x + 1]]
            ...
            return [automata[y][x - 1], automata[y + 1][x], automata[y + 1][x - 1]]
            ...
            return [automata[y + 1][x], automata[y - 1][x], automata[y - 1][x + 1], automata[y][x + 1], automata[y + 1][x + 1]]
            ...
            return [automata[y][x - 1], automata[y][x + 1], automata[y + 1][x - 1], automata[y + 1][x], automata[y + 1][x + 1]]
            ...
            return [automata[y - 1][x - 1], automata[y - 1][x], automata[y - 1][x + 1], automata[y][x - 1],
                    automata[y + 1][x - 1], automata[y + 1][x], automata[y + 1][x + 1], automata[y][x + 1]]
...
if __name__ == "__main__":
    ...
    conway = GameOfLife((args.width, args.height),
                        ...
                        args.density, args.tau,
                        args.average_timestamp, parse_extremes())
